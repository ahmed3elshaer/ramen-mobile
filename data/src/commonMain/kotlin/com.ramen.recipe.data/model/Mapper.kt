...
internal fun SearchRecipeApi.toDomain() = SearchRecipe(id = this.id,
		image = this.image,
...
internal fun SearchRecipeApi.Ingredient.toDomain() = SearchRecipe.Ingredient(
		aisle = this.aisle,
		amount = this.amount,
		id = this.id,
		image = this.image,
...
internal fun IngredientApi.toDomain() = com.ramen.ingredients.domain.model.Ingredient(
		id = this.id,
		image = this.image,
		name = this.name,
		aisle = this.aisle,
...
internal fun com.ramen.ingredients.domain.model.Ingredient.toData() = IngredientApi(
		id = this.id,
		image = this.image,
		name = this.name,
		aisle = this.aisle,
...
internal fun AutocompleteIngredientApi.toDomain() = AutocompleteIngredient(
		id = this.id,
		name = this.name,
		image = this.image
