...
struct selection: View {
    ...
    fileprivate func defaultStyle() -> some View {
        ...
        .padding()
        .background(RoundedRectangle(cornerRadius: 5).foregroundColor(focused ? Color.basic.opacity(0) : Color.basic.opacity(0.1)))
        .overlay(RoundedRectangle(cornerRadius: 5).stroke(focused ? Color.defaultPrimary : Color.basic.opacity(0.4), lineWidth: 1))
    }
