    ...
    static var previews: some View {
        ...
        VStack(spacing : 20) {
            ...
            HStack(spacing: 20) {
                ...
                Button(action : {}, label: {Image(systemName: "star.fill").square(width: brSize.large.iconScale)})
                    .buttonStyle(ButtonGroupStyle(sizesStyle: .medium, colorStyle: .basic))
                
                Button(action : {}, label: {Image(systemName: "person").square(width: brSize.large.iconScale)})
                    .buttonStyle(ButtonGroupStyle(sizesStyle: .medium, colorStyle: .outline))
                
                Button(action : {}, label: {Image(systemName: "umbrella").square(width: brSize.large.iconScale)})
